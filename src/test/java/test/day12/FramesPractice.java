...
public class FramesPractice {
    ...
    public void setup(){
        ...
        driver.navigate().to("http://practice.cybertekschool.com/frames");
    ...
    public void Test1(){
        ...
        Assert.assertEquals(expectedText, actualText, "check the text");
        ...
        BrowserUtils.wait(2);
        inputArea.sendKeys("Hello Ibrahim naberrrr broooo");
        BrowserUtils.wait(3);
