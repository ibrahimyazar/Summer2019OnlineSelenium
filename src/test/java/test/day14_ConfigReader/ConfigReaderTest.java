package test.day14_ConfigReader;
...
//    password=UserUser123
    ...
    public void test(){
        ...
        System.out.println("URL: " + ConfigurationReader.getProperty("url"));   //read value of url property
        System.out.println("Browser: " + ConfigurationReader.getProperty("browser"));
        System.out.println("User Name: " + ConfigurationReader.getProperty("User_name"));  //read value of user_name property
        System.out.println("Password: " + ConfigurationReader.getProperty("Password"));     //read value of password property
